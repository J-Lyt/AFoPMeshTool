...
for _cache_dir in (
    ...
    os.path.join(_package_dir, "formats", "__pycache__"),
...
classes = (
    ...
    operators_io.BrowseSourceMMBFile,
    operators_io.BrowseSourceMClothFile,
    operators_io.BrowseSourceMReflexFile,
    operators_io.BrowseMClothFile,
    ...
    operators_sdf.ShowAllSDFResults,
